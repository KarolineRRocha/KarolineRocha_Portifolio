...
(function() {
  ...
  window.__env__ = {
    API_URL: '${PORTFOLIO_API_URL:-https://your-production-api.com/api}',
    GITHUB_USERNAME: '${PORTFOLIO_GITHUB_USERNAME:-KarolineRRocha}',
    GITHUB_TOKEN: '${PORTFOLIO_GITHUB_TOKEN:-}',
    EMAILJS_SERVICE_ID: '${PORTFOLIO_EMAILJS_SERVICE_ID:-}',
    EMAILJS_TEMPLATE_ID: '${PORTFOLIO_EMAILJS_TEMPLATE_ID:-}',
    EMAILJS_USER_ID: '${PORTFOLIO_EMAILJS_USER_ID:-}',
    ADMIN_USERNAME: '${PORTFOLIO_ADMIN_USERNAME:-}',
    ADMIN_PASSWORD: '${PORTFOLIO_ADMIN_PASSWORD:-}',
    FIREBASE_API_KEY: '${PORTFOLIO_FIREBASE_API_KEY:-}',
    FIREBASE_AUTH_DOMAIN: '${PORTFOLIO_FIREBASE_AUTH_DOMAIN:-}',
    FIREBASE_DATABASE_URL: '${PORTFOLIO_FIREBASE_DATABASE_URL:-}',
    FIREBASE_PROJECT_ID: '${PORTFOLIO_FIREBASE_PROJECT_ID:-}',
    FIREBASE_STORAGE_BUCKET: '${PORTFOLIO_FIREBASE_STORAGE_BUCKET:-}',
    FIREBASE_MESSAGING_SENDER_ID: '${PORTFOLIO_FIREBASE_MESSAGING_SENDER_ID:-}',
    FIREBASE_APP_ID: '${PORTFOLIO_FIREBASE_APP_ID:-}',
    FIREBASE_MEASUREMENT_ID: '${PORTFOLIO_FIREBASE_MEASUREMENT_ID:-}'
  };
